...
public interface UserDao {
	 ...
	 * @throws SQLException
	 */
	int deleteUsers(int[] userIdList) throws SQLException;
	 ...
	 * @throws SQLException
	 */
	ArrayList<User> getUserList(int pageSize, int rowNum, User one)
			throws Exception;
	 ...
	 * @throws SQLException
	 */
	int updateUser(User one) throws Exception;
	ArrayList<User> getUserList(int rowNum, User one)
			throws Exception;
